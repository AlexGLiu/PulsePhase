...
def create_data(kind, num, labels = {}, output_path = 'classifier_data', seed = 13):
    ...
    while count < num:
        ...
        labels[thisID] = {'roof':0, 'linear':1, 'second':2}[kind]
        count += 1
...
if __name__ == "__main__":
    labels = {}
    output_path = 'classifier_data'
    total_num = 10000

    for kind in ['roof', 'linear', 'second']:
        labels = create_data(kind, total_num, labels = labels, output_path = output_path)
